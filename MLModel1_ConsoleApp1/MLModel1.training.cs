...
namespace MLModel1_ConsoleApp1
{
    ...
    {
        public const string RetrainFilePath =  @"D:\github\ml-trainer-predictor\MLTrainer\Demo\MicroGasTurbineElectricalEnergyPrediction\example.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"time", @"time"),new InputOutputColumnPair(@"input_voltage", @"input_voltage")})      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"time",@"input_voltage"}))      
                                    .Append(mlContext.Regression.Trainers.LbfgsPoissonRegression(new LbfgsPoissonRegressionTrainer.Options(){L1Regularization=1.907553F,L2Regularization=0.4765247F,LabelColumnName=@"el_power",FeatureColumnName=@"Features"}));
