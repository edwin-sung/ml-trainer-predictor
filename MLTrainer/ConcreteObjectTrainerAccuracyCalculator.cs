...
namespace MLTrainer.CompileTimeTrainingSetup.ConcreteObjectTrainer
{
    ...
    /// </summary>
    internal class ConcreteObjectTrainerAccuracyCalculator<ModelInput, ModelOutput> 
        ...
        where ModelOutput : class, new()
    {
        ...
        internal ConcreteObjectTrainerAccuracyCalculator(MLContext mlContext, IEnumerable<ModelInput> testSet, IDataView transformedTestSet, string trainedModelFilePath)
        {
